                                ...
                                <div style="margin-top: 20px">
                                    ...
                                    <div style="display: flex">
                                        ...
                                        <form action="{{'/editCompany/delete/'.$item->id}}" method="post">
                                            ...
                                            {{method_field('post')}}
                                            <center>
                                                <button class="btn btn-danger" onclick="return confirm('Are you sure to Delete this Company?')" style="margin-left: 130px; margin-right: auto; display: flex; justify-content: center; margin-top: 20px">Delete</button>
                                            </center>
                                        </form>
                                    </div>
                                </div>
