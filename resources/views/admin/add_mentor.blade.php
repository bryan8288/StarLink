    ...
    <div class="container-fluid" style="padding-top: 50px">
        <form action="{{url('/addMentor/add')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="mentorDetail">
                ...
                <input style="width:70%; float: right;" type="text" name="username" class="form-control text-truncate"
            ...
            <div class="mentorDetail">
                ...
                <input style="width:70%; float: right;" type="text" name="email" class="form-control text-truncate"
                    style="margin-bottom: 5px">
            </div>
            <div class="mentorDetail">
