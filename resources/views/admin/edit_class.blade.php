                    ...
                    <div class="container-fluid" style="padding-top: 50px">
                        @if($auth && \Illuminate\Support\Facades\Auth::user()->role != 'admin')
                            ...
                            <div class="courseDetail">
                                ...
                                <select name="course" class="form-control input-sm" disabled
                            ...
                            <div class="courseDetail">
                                ...
                                <select name="mentor" class="form-control input-sm" disabled
                                    style="margin-bottom: 5px; width:70%;">
                            ...
                            <div class="courseDetail">
                                ...
                                <input style="width:70%; float: right;" type="time" name="start_time" readonly
                                    class="form-control" value="{{$class->start_time}}" style="margin-bottom: 5px">
                            </div>
                            <div class="courseDetail">
                            ...
                            <div style="margin-top: 30px">
                                ...
                                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="popupmodel"
                                    aria-hidden="true">
                                                ...
                                                <table class="table">
                                                    ...
                                                    <form action="{{url('addMenteeToClass/'.$id)}}" method="post">
                                                        ...
                                                        <tbody style="text-align: center">
                                                            ...
                                                            <tr class="table-info">
                                                                <th scope="row">
                                                                    <input name="menteeId[]" class="form-check-input"
                        ...
                        <form action="{{url('editClass/update/'.$class->id)}}" method="post">
                            ...
                            <div class="courseDetail">
                                <h5 style="width: 30%;float:left">Start Time</h5>
                                <input style="width:70%; float: right;" type="time" name="start_time"
                                    class="form-control" value="{{$class->start_time}}" style="margin-bottom: 5px">
                            </div>
                            <div class="courseDetail">
                                <h5 style="width: 30%;float:left">End Time</h5>
