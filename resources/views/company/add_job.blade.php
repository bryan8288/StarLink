                    ...
                    <div class="container-fluid" style="padding-top: 50px">
                        <form action="{{url('/addJob/add')}}" method="post">
                            ...
                            <div class="courseDetail">
                                ...
                                <input style="width:70%; float: right;" type="text" name="language" class="form-control" style="margin-bottom: 5px">
                            </div>
                            <div class="courseDetail">
                                <h5 style="width: 30%;float:left">Capacity</h5>
                                <input style="width:70%; float: right;" type="number" name="capacity" class="form-control" style="margin-bottom: 5px">
                            </div>
                            <div class="courseDetail">
                                <h5 style="width: 30%;float:left">Salary</h5>
                                <input style="width:70%; float: right;" type="text" name="salary" class="form-control" style="margin-bottom: 5px">
                            </div>
                            <div class="courseDetail">
