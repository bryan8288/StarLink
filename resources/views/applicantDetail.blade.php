    ...
    <div id="background" style="height:100%">
        <div class="row" style="">
            ...
            <div class="col-sm" style="">
                ...
                @foreach ($scoreDetail as $score)
                <div style="background:#0099FF;padding:10px;width: fit-content; color:white;font-weight: bold;cursor:context-menu; margin-bottom:5px; display:inline-block">{{$skill->name}} || {{$score->score}}</div>
                @endforeach
